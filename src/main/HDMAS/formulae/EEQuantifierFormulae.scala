...
class EEQuantifierFormulae(nested:Formulae,var1:Variable,var2:Variable) extends QuantifierFormulae(nested,var1,var2){
  ...
  override def negate(): Formulae = {
    ...
    //val v2_1:Variable = this.getQuantifiedVariable2_1
    val v2:Variable = this.getQuantifiedVariable2
    this.quantifierFormulaFactory(QuantifierType.FF, n, v1,v2)
  }

  override def stringQuantifier(): String = "EE"

  override def getFormulaType: FormulaeType = FormulaeType.EE
